    ...
    <div className="flex flex-col gap-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <div className="card">
          <div className="card-header">
            ...
            <p className="card-title">Total Properties</p>
          </div>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <p className="card-title">Total Tenants</p>
          </div>
          <div className="card-body bg-slate-100 transition-colors dark:bg-slate-950">
            <p className="text-3xl font-bold text-slate-900 transition-colors dark:text-slate-50">
              $16,000
        ...
        <div className="card">
          <div className="card-header">
            ...
            <p className="card-title">Monthly Maintenance</p>
          </div>
          <div className="card-body bg-slate-100 transition-colors dark:bg-slate-950">
            <p className="text-3xl font-bold text-slate-900 transition-colors dark:text-slate-50">
              12,340
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <div className="card col-span-1 md:col-span-2 lg:col-span-4">
          <div className="card-header">
            <p className="card-title">Rent Income</p>
          </div>
        ...
        <div className="card col-span-1 md:col-span-2 lg:col-span-3">
          <div className="card-header">
            <p className="card-title">Recent Maintenance</p>
          </div>
